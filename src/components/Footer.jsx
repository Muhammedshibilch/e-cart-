...
const Footer = () => {
  return (
    <footer className="bg-orange-400 text-white py-8 " style={{marginTop:"100px"}}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-3">
              <i className="fas fa-truck text-white text-2xl mr-2"></i>
              <h3 className="text-xl font-bold">Daily cart</h3>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center mb-4">
              ...
              />
              <button className="p-2 bg-orange-700 rounded-r">
