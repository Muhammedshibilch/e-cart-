...
<img src="https://c.tenor.com/0iK9a1WkT40AAAAM/loading-white.gif" width={'70px'} height={'70px'} className="me-3" alt="" />
...
visibleAllProducts?.map(product=>(
          <div key={product?.id} className="rounded border p-2 shadow">
            ...
            <div className="text-center">
              ...
              <Link
                to={`/${product?.id}/view`}
                className="bg-orange-400 rounded p-1 mt-3 text-white inline-block"
              >
                View More..
              </Link>
            </div>
